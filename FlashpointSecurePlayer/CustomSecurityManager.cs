...
namespace FlashpointSecurePlayer {
    public sealed class CustomSecurityManager : InternetInterfaces.IServiceProvider, InternetInterfaces.IInternetSecurityManager {
        private readonly byte[] FLASH_CONTEXT = { 110, 219, 124, 210, 109, 174, 207, 17, 150, 184, 68, 69, 83, 84, 0, 0 };
        ...
        int InternetInterfaces.IInternetSecurityManager.QueryCustomPolicy(
        ...
        int InternetInterfaces.IInternetSecurityManager.SetZoneMapping(
            uint dwZone,
